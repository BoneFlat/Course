...
namespace JackieSoft
{
    ...
    public class ListView : MonoBehaviour
    {
        ...
        [SerializeReference, SubclassSelector] private Layout verticalLayout = new Vertical();
        [SerializeReference, SubclassSelector] private Order ascendingOrder = new Ascending();
        ...
        private void Awake()
        {
            ...
            verticalLayout.Set(_scrollRect);
            verticalLayout.Awake(_tContent, padding, _scrollRect.viewport.rect, ascendingOrder, spacing);
            ascendingOrder.Awake(_leHeader.GetComponent<RectTransform>(), _leFooter.GetComponent<RectTransform>());
        }
        ...
        {
            var pointStart = verticalLayout.CalculatePoint(val);
 
            var pointEnd = pointStart + verticalLayout.listViewSize;
        ...
        private void CorrectSibling()
        {
            ...
            for (var i = _top; i <= _bottom; i++)
                ascendingOrder.SetSibling(((Component)_cells[i].view).transform, i - _top, count);
        }
        ...
        {
            var listViewSize = verticalLayout.listViewSize;
            _cells = new Cell[data.Count];

            var contentSize = verticalLayout.firstPadding;

            var cell0size = verticalLayout.CellSize(_cellCreator.CellSize(data[0]));
            // cell 0;
            _cells[0] = new Cell
            {
                data = data[0],
            ...
            {
                var cellData = data[i];
                var cellSize = verticalLayout.CellSize(_cellCreator.CellSize(cellData));
            ...
            // cell n - 1
            var cellLastSize = verticalLayout.CellSize(_cellCreator.CellSize(data[data.Count - 1]));
            _cells[_cells.Length -1] = new Cell
            {
                ...
                size = cellLastSize,
                top = contentSize - 0.5f * spacing,
                down = contentSize + cellLastSize + verticalLayout.lastPadding,
            };

            contentSize = contentSize + cellLastSize + verticalLayout.lastPadding;
            ...
            verticalLayout.SetContent(contentSize);
        ...
        private void CorrectHeader()
        {
            ...
            else
            {
                ...
                verticalLayout.SetElement(_leHeader, _cells[_top].point - _cells[0].point - spacing);
                ascendingOrder.SetHeaderSibling();
            }
        }
        ...
        private void CorrectFooter()
        {
            ...
            else
            {
                ...
                verticalLayout.SetElement(_leFooter, _cells[_cells.Length - 1].point - _cells[_bottom].point - spacing - _cells[_bottom].size + _cells[_cells.Length - 1].size);
                ascendingOrder.SetFooterSibling();
            }
        }
        ...
        public abstract class Layout
        {
            ...
            protected Order ascendingOrder;
            ...
            public abstract void SetElement(LayoutElement verticalLayoutElement, float size);
            ...
            public void Awake(RectTransform content, RectOffset padding, Rect viewport, Order ascendingOrder, float spacing)
            {
